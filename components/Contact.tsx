      ...
      <div className="max-w-3xl mx-auto">
        <RevealOnScroll>
          <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="pt-8">
               <button type="submit" className="w-full bg-fg text-bg py-5 uppercase tracking-[0.2em] text-xs font-black hover:bg-accent hover:text-bg transition-colors duration-300 rounded-full">
                 Submit Inquiry
               </button>
            </div>
          </form>
